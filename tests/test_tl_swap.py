...
def test_tl_swap_emit_initiated_event(tl_swap_contract):
    tl_swap_contract.functions.commit("0x9f9f3792287e87d84590E3fe3fD0B34B6E60531e", "0x94934A417e05091319048701bd4cF61DC48962ac",
                                      "0xa6C7310A1fc7A806Fd7c20B4b030501fCe2AC977", 100, "0xBf6CA0E4b2B5C788dB424383A95fd019d2EB717f", 1, WEEK_SECONDS,
                                      HASHED_SECRET ).transact()

    commit_initiated_event = get_single_event_of_contract(
        tl_swap_contract,
        "CommitmentInitiatedEvent",
        0,
    )["args"]
...
def test_tl_swap_commit_entry_alredy_exists(tl_swap_contract):
    ...
    tl_swap_contract.functions.commit("0x9f9f3792287e87d84590E3fe3fD0B34B6E60531e",
                                          "0x94934A417e05091319048701bd4cF61DC48962ac",
                                          "0xa6C7310A1fc7A806Fd7c20B4b030501fCe2AC977", 100,
                                          "0xBf6CA0E4b2B5C788dB424383A95fd019d2EB717f", 1, WEEK_SECONDS,
                                          "f81b517a242b218999ec8eec0ea6e2ddbef2a367a14e93f4a32a39e260f686ad").transact()

    with pytest.raises(exceptions.TransactionFailed) as excinfo:

        tl_swap_contract.functions.commit("0x9f9f3792287e87d84590E3fe3fD0B34B6E60531e",
                                      "0x94934A417e05091319048701bd4cF61DC48962ac",
                                      "0xa6C7310A1fc7A806Fd7c20B4b030501fCe2AC977", 200,
                                      "0xBf6CA0E4b2B5C788dB424383A95fd019d2EB717f", 1, WEEK_SECONDS,
                                      "f81b517a242b218999ec8eec0ea6e2ddbef2a367a14e93f4a32a39e260f686ad").transact()
...
def test_tl_swap_commit_tl_money_required(tl_swap_contract):
    with pytest.raises(exceptions.TransactionFailed) as excinfo:
        ...
        tl_swap_contract.functions.commit("0x9f9f3792287e87d84590E3fe3fD0B34B6E60531e",
                                      "0x94934A417e05091319048701bd4cF61DC48962ac",
                                      "0xa6C7310A1fc7A806Fd7c20B4b030501fCe2AC977", 0,
                                      "0xBf6CA0E4b2B5C788dB424383A95fd019d2EB717f", 1, WEEK_SECONDS,
                                      "f81b517a242b218999ec8eec0ea6e2ddbef2a367a14e93f4a32a39e260f686ad").transact()
...
def test_tl_swap_commit_eth_amount_required(tl_swap_contract):
    with pytest.raises(exceptions.TransactionFailed) as excinfo:
        tl_swap_contract.functions.commit("0x9f9f3792287e87d84590E3fe3fD0B34B6E60531e",
                                          "0x94934A417e05091319048701bd4cF61DC48962ac",
                                          "0xa6C7310A1fc7A806Fd7c20B4b030501fCe2AC977", 100,
                                          "0xa6C7310A1fc7A806Fd7c20B4b030501fCe2AC977", 0, WEEK_SECONDS,
                                          "f81b517a242b218999ec8eec0ea6e2ddbef2a367a14e93f4a32a39e260f686ad").transact()
...
def test_tl_swap_claim_tl_money(tl_swap_contract, tl_currency_network_contract):
    tl_swap_contract.functions.commit("0x9f9f3792287e87d84590E3fe3fD0B34B6E60531e",
                                      "0x94934A417e05091319048701bd4cF61DC48962ac",
                                      tl_currency_network_contract.address, 100,
                                      "0xBf6CA0E4b2B5C788dB424383A95fd019d2EB717f", 1, WEEK_SECONDS,
                                      HASHED_SECRET).transact()
    ...
    extra_data = b""
    tl_swap_contract.functions.claim(["0x9f9f3792287e87d84590E3fe3fD0B34B6E60531e", "0x94934A417e05091319048701bd4cF61DC48962ac"],
                                     MAX_FEE, extra_data, SECRET).transact()

    currency_transfer_called = get_single_event_of_contract(
        tl_currency_network_contract,
        "Transfer",
        0,
    )["args"]

    assert currency_transfer_called._from == "0x9f9f3792287e87d84590E3fe3fD0B34B6E60531e"
...
def test_tl_swap_remove_commitment(tl_swap_contract):
    tl_swap_contract.functions.commit("0x9f9f3792287e87d84590E3fe3fD0B34B6E60531e",
                                      "0x94934A417e05091319048701bd4cF61DC48962ac",
                                      "0xa6C7310A1fc7A806Fd7c20B4b030501fCe2AC977", 100,
                                      "0xBf6CA0E4b2B5C788dB424383A95fd019d2EB717f", 1, 0,
                                      HASHED_SECRET).transact()
